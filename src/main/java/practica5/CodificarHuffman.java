...
public class CodificarHuffman {
    ...
    public int[][] codificarmatriz(ArbolHuffman arbol, int[][] matriz) {
        ...
        for (int i = 0; i < matriz.length; i++) {
            for (int j = 0; j < matriz[i].length; j++) {
                ...
                System.out.println("Valor pixel: " + matriz[i][j]);
                System.out.println("Valor codificado: " + arbol.obtenercodificacionpixel(matriz[i][j], arbol.getRaiz()));
            }
            matrixcodificada[i] += arbol.obtenercodificacionpixel(256, arbol.getRaiz());
            System.out.println("Valor pixel: " + 256);
            System.out.println("Valor codificado: " + arbol.obtenercodificacionpixel(256, arbol.getRaiz()));
    ...
    public static int deStringAentero(String numerocodificado) {
